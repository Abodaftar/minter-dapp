...
const namePrefix = "DEGEN X";
const description = "The Ultimate Degen X NFT Collection";
...
const extraMetadata = {
  external_url: "https://degenxnft.xyz", // Replace with your website or remove this line if you do not have one.
};
